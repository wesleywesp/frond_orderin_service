...
export const GET_MENU_ITEMS_BY_RESTAURANT_REQUEST = "GET_MENU_ITEMS_BY_RESTAURANT_REQUEST";
export const GET_MENU_ITEMS_BY_RESTAURANT_SUCCESS = "GET_MENU_ITEMS_BY_RESTAURANT_SUCCESS";
export const GET_MENU_ITEMS_BY_RESTAURANT_FAILURE = "GET_MENU_ITEMS_BY_RESTAURANT_FAILURE";
