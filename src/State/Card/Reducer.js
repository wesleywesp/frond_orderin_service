...
export const cartReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.GET_ALLCART_ITEMS_REQUEST:
        case actionTypes.UPDATE_CARITEM_REQUEST:
        ...
        case actionTypes.UPDATE_CARITEM_SUCCESS:
            return {
                ...state,
                loading: false,
        ...
        case actionTypes.UPDATE_CARITEM_FAILURE:
